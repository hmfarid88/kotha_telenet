...
<html class="no-js" lang="">
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                        ...
                                        %>
                                        <label>STOCK QTY </label><input type="text" size="5px" class="text-center form-control" value="${qty} ps " readonly="">  
                                </div>
                                <div class="col-sm-2">
                                ...
                                <center>
                                    ...
                                    <table border="2" id="mobiletable" class="table-striped table-responsive" width="90%" >
                                        ...
                                        <%
                                            ...
                                            try {
                                                con = Ssymphonyy.getConnection();
                                                String query = "select BRAND, MODEL, COLOR, PURCHASE_PRICE, SELL_PRICE, count(*) as qty from stock where MODEL not like '%"+ demo +"%'  group by BRAND, MODEL, COLOR, PURCHASE_PRICE, SELL_PRICE";
                                                ps = con.prepareStatement(query);
                                                rs = ps.executeQuery();
                                                while (rs.next()) {
                                        %>
