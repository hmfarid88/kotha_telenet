...
<html class="no-js" lang="">
                                ...
                                <div id="div_print">
                                    <center>
                                        ...
                                        <h4>Date: ${param.date1} To ${param.date2} </h4>
                                          <hr>
                                        <h4>Brand Name : ${param.proname}</h4>
                                        ...
                                        <table  border="2" width="95%" class="table-striped table-responsive myTables " >
                                            ...
                                            <tbody>
                                                <%  
                                                    ...
                                                    try {
                                                        ...
                                                        String query = "select MODEL, COLOR, PRICE, COST_PRICE, count(PRODUCT_ID) as qty, PRICE-COST_PRICE as uprofit, sum(DISCOUNT) as dis"
                                                                + " from mobilesell where BRAND LIKE '%"+ proname +"%' and  SELL_DATE between '" + date1 + "'  and '" + date2 + "' group by MODEL, COLOR, PRICE";
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center"> <%= rs.getFloat("uprofit")-rs.getFloat("dis")%> </td>
                                                    <td style="text-align: center"><%= (rs.getFloat("uprofit")-rs.getFloat("dis")) * rs.getFloat("qty")%> </td>
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                                ...
                                                <%            
                                                    try {
                                                        ...
                                                        String query = "select sum(PRICE) as saleprice, sum(COST_PRICE) as cost, count(PRODUCT_ID) as tqty, sum(DISCOUNT) as totaldis"
                                                                + " from mobilesell where BRAND LIKE '%"+ proname +"%' and  SELL_DATE between '" + date1 + "'  and '" + date2 + "'";
                                                        ps = con.prepareStatement(query);
                                                        rs = ps.executeQuery();
                                                        while (rs.next()) {
                                                ...
                                                <tr style="background-color: #cccccc">
                                                    ...
                                                    <th></th>
                                                    <th style="text-align: center"><%= rs.getFloat("saleprice") - (rs.getFloat("cost")+rs.getFloat("totaldis"))%></th>
