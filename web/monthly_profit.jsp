                                                ...
                                                <%
                                                    ...
                                                    try {
                                                        ...
                                                        String query = "select BRAND, MODEL, PRICE, COST_PRICE, count(*) as qty, (PRICE-COST_PRICE) as uprofit, sum(DISCOUNT) as dis"
                                                                + " from mobilesell where YEAR(SELL_DATE) = YEAR(CURRENT_DATE()) AND MONTH(SELL_DATE) = MONTH(CURRENT_DATE())  group by BRAND, MODEL, COST_PRICE, PRICE";
                                                ...
                                                <tr>
                                                    <th Style="text-align: center">Mobile Phone</th>
                                                        <%                                                            
                                                            try {
                                                                con = Ssymphonyy.getConnection();
                                                                String query = "select sum(PRICE) as saleprice, sum(DISCOUNT) as dis, sum(COST_PRICE) as cost, count(PRODUCT_ID) as tqty"
                                                                        + " from mobilesell where YEAR(SELL_DATE) = YEAR(CURRENT_DATE()) AND MONTH(SELL_DATE) = MONTH(CURRENT_DATE()) ";
                                                                ps = con.prepareStatement(query);
                                                                rs = ps.executeQuery();
                                                                while (rs.next()) {
                                                                    ...
                                                                    request.setAttribute("mdist", rs.getFloat("dis"));
                                                        %>
                                                    ...
                                                    <td Style="text-align: center"><%= rs.getFloat("saleprice") - rs.getFloat("cost")-rs.getFloat("dis")%></td>
                                                    <td Style="text-align: center"><%= ((rs.getFloat("saleprice") - rs.getFloat("cost")-rs.getFloat("dis"))*100)/rs.getFloat("cost") %> %</td>
                                                    <%                  }
                                                        } catch (Exception ex) {
                                                        }finally {
   try { if (rs != null) rs.close(); rs=null; } catch (SQLException ex2) { }
