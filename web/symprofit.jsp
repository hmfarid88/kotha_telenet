...
<html class="no-js" lang="">
                        ...
                        <nav style="margin: 0 auto" class="navbar navbar-inverse">
                            ...
                            <div class="collapse navbar-collapse" id="myNavbar">
                                    ...
                                    <li>
                                        <div id="dateview" class="collapse" style="margin:10px 20px">
                                            <form action="datewise_profit.jsp" method="POST" class="form-inline">
                                                ...
                                                <label style="color: white">TO</label> <input type="date" autocomplete="off" class=" form-control input-sm " size="10px" name="date2" value="" required="" placeholder="End Date" >
                                ...
                                <li>
                                    ...
                                    <label style="color: white">to</label> <input type="date" class=" form-control input-sm " size="10px"  name="date2" value="" required="" placeholder="End Date" >
                                        ...
                                        <table  border="2" width="95%" class="table-striped table-responsive myTables" >
                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    try {
                                                        ...
                                                        String query = "select BRAND, MODEL, PRICE, COST_PRICE, count(*) as qty, (PRICE-COST_PRICE) as uprofit, sum(DISCOUNT) as dis"
                                                                + " from mobilesell where SELL_DATE=CURDATE()  group by BRAND, MODEL, COST_PRICE, PRICE";
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="text-align: center"><%= (rs.getLong("PRICE")-(rs.getLong("COST_PRICE")+rs.getLong("dis"))) * rs.getLong("qty")%> </th>
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                            ...
                                            <%                                                    
                                                ...
                                                <tr style="background-color: #030303; color: #ffffff">
                                                    ...
                                                    <th style="text-align: center"><%= rs.getLong("profit")-rs.getLong("totaldis") %></th>
                                                </tr>
                                                 <%                                                            }
                                                        } catch (Exception ex) {
                                                        }finally {
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                        ...
                                        <table  border="2" width="95%" class="table-striped table-responsive myacTables" >
                                            <thead>
                                                <tr style=" background-color: #030303; color: #ffffff">
                                                    <th style="text-align: center">SN</th>
                                                    <th style="text-align: center">Products</th>
                                                ...
                                                <%                                                    
                                                 try {
                                                        ...
                                                        String query = "select PRODUCT_NAME, SELL_PRICE, COST_PRICE, sum(DISCOUNT) as dss, count(*) as aqty, SELL_PRICE-COST_PRICE as auprofit"
                                                                + " from accessor_sale where DATE=CURDATE() group by PRODUCT_NAME, COST_PRICE, SELL_PRICE";
                                                        ps = con.prepareStatement(query);
                                                        rs = ps.executeQuery();
                                                        while (rs.next()) {
                                                ...
                                                <%                                                    
                                                    try {
                                                        ...
                                                        String query = "select sum(SELL_PRICE-COST_PRICE) as aprofit, sum(DISCOUNT) as ttdis, count(PRODUCT_ID) as atqty"
                                                                + " from accessor_sale where DATE=CURDATE() ";
                                                        ps = con.prepareStatement(query);
                                                        rs = ps.executeQuery();
                                                        while (rs.next()) {
                                                %>
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                        ...
                                        <table  border="2" id="sumtable" width="95%" class="table-striped table-responsive" >
                                            <thead>
                                                <tr style=" background-color: #030303; color: #ffffff">
                                                ...
                                                <tr>
                                                    <th Style="text-align: center">Mobile Phone</th>
                                                        <%                                                            
                                                            try {
                                                                con = Ssymphonyy.getConnection();
                                                                String query = "select sum(PRICE) as saleprice, sum(DISCOUNT) as disamount, sum(COST_PRICE) as cost, count(PRODUCT_ID) as tqty"
                                                                        + " from mobilesell where SELL_DATE=CURDATE() ";
                                                                ps = con.prepareStatement(query);
                                                                rs = ps.executeQuery();
                                                                while (rs.next()) {
                                                                    ...
                                                                    request.setAttribute("totaldis", rs.getFloat("disamount"));
                                                        %>
                                                    ...
                                                    <td Style="text-align: center"><%= rs.getFloat("saleprice") - rs.getFloat("cost")-rs.getFloat("disamount") %></td>
                                                    <td Style="text-align: center"><%= ((rs.getFloat("saleprice") - rs.getFloat("cost")-rs.getFloat("disamount"))*100)/rs.getFloat("cost") %> %</td>
                                                    <%                  }
                                                        } catch (Exception ex) {
                                                        }finally {
   try { if (rs != null) rs.close(); rs=null; } catch (SQLException ex2) { }
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                                ...
                                                <tr>
                                                    ...
                                                    <td Style="text-align: center">${(msale+asale)-(mcost+acost+acsordis+totaldis)}</td>
                                                    <td Style="text-align: center">${(((msale+asale)-(mcost+acost+acsordis+totaldis))*100)/(mcost+acost)} %</td>
                                                </tr> 
                                                <tr>
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                                        ...
                                                        <%
                                                            ...
                                                            try {
                                                                ...
                                                                String query = "select sum(AMOUNT) as pcost from profit_cost where DATE=CURDATE()";
                                                                ps = con.prepareStatement(query);
                                                                rs = ps.executeQuery();
                                                                while (rs.next()) {
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                                ...
                                                <tr>
                                                    ...
                                                    <th style=" text-align: center; border-bottom-style: hidden; border-left-style: hidden; border-right-style: hidden"><u>${((msale+asale)-(mcost+acost+acsordis+totaldis))-(tcost+pcost)}</u> | (<u>${(((msale+asale)-(mcost+acost+acsordis+totaldis))-(tcost+pcost))*100/(mcost+acost)} </u> %)</th>
