...
<html class="no-js" lang="">
   ...
   border-bottom:none;
    ...
    <body ng-app="myApp" ng-controller="myCtrl" style=" background-color:#030303; height: 100%">
    ...
    <div class=" container-fluid" id="main" >
        ...
        <div class="panel panel-success" style=" background-color: #030303; border-color: #030303">            
        
            <nav id="nav" style="margin:0 auto;height: 105px; z-index: 1000; border-color: black" class="navbar navbar-inverse">
                <div  class=" container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar" style="background-color: #030303;">
                        <ul class="nav navbar-nav">

                            <li id="drop">
                                <a href="#"><button style=" margin: 5px 18px" class="btn btn-success"><span class="fa fa-database fa-2x"></span></button><br><b>Stock View</b></a>
                            ...
                            <li id="drop">
                                <a href="#"> <button style=" margin: 5px 6px" class="btn btn-success"><span class="fa fa-file-text-o fa-2x"></span></button><br> <b>Ledger</b></a>
                                <div  id="dropdown" class=" dropdown-menu">
                            ...
                            <li>
                                <a id="cashbook" href="cash_book.jsp"> <button style=" margin: 5px 22px" class="btn btn-success"><span class="fa fa-book fa-2x"></span></button><br><b> Cash Book</b></a>
                            </li>


                            <li id="drop">
                                <a href="#"> <button style=" margin: 5px 5px" class="btn btn-success"><span class="fa fa-search fa-2x"></span></button><br><b>Search</b></a>
                                <div  id="dropdown" class=" dropdown-menu">
                            ...
                            <li id="drop">
                                <a href="#"><button style=" margin: 5px 20px" class="btn btn-success"> <span class="fa fa-cogs fa-2x"></span></button> <br><b style=" margin-left: 12px">Settings</b></a>
                                <div  id="dropdown" class=" dropdown-menu">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <a id="lgn" href="LogoutServlet">  <button style=" margin: 5px 5px" class="btn btn-success"> <span class="fa fa-sign-out fa-2x"></span></button> <br><b> Logout</b></a></li>
                        </ul> 
                    </div>
                </div>
            </nav>
<%
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                            ...
                            <div class="col-sm-4 col-md-4">
                                <a href="totalStock.jsp">  <button style=" border-bottom-left-radius: 50px; border-top-right-radius: 50px" class="btn btn-success btn-block"><h3><strong> Stock Info<br> ${stocktotal}|${stockqty}<br>${astocktotal}|${astockqty} </strong></h3></button></a>
                            </div>
                            <div class="col-sm-4 col-md-4">
                                <a href="symsellview.jsp"><button style=" border-bottom-left-radius: 50px; border-top-right-radius: 50px" class="btn btn-success btn-block"><h3><strong> Sale Info<br> ${saletotal}|${tqty}<br> ${asaletotal}|${atqty}</strong></h3></button></a>
                            </div>
                           <%                                
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                ...
                                %>
                                <a href="cash_book.jsp"> <button style=" border-bottom-left-radius: 50px; border-top-right-radius: 50px" class="btn btn-success btn-block"><h3><strong>Balance <br>Cash | Bank <br> ${nbalance} |${deposittotal-withtotal}</strong></h3></button> </a>
