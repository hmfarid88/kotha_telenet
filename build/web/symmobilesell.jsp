                                ...
                                <div class="col-sm-3">
                                    <form id="saleform" method="POST" action="SellEntryServlet">
                                       <input type="hidden" name="cid" value="${iid+1}">
                                        ...
                                        <select style=" max-width: 70%" class="form-control input-sm select2"  onchange="this.form.submit()"  name="imei" value=""  required="">
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                ...
                                <div class="col-sm-3">
                                    <form id="saleform" method="POST" action="AccessorSaleServlet">
                                        <label>Add Manually</label>  <br>
                                         <input type="hidden" name="cid" value="${iid+1}">
                                         <select style=" max-width: 70%" class="form-control input-sm select2" onchange="this.form.submit()" name="accessorid"  value="" required="">
            ...
            rs01.next();
                                    ...
                                    <center>
                                        <form id="disform" method="POST" action="MdiscountServlet" class=" form-inline">
                                            ...
                                            <input type="number" style="width:100px;text-align: center; color: black" name="discount" id="discount" value="<%= rs.getFloat("DISCOUNT") %>" required=""><br>
                                            <input type="text" name="note" title="Discount Note" style="width:100px;text-align: center; color: black; margin-top: 2px" value="<%= rs.getString("DIS_NOTE") %>" onchange="myFunction()" placeholder="Note" ><br>
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                    ...
                                    <center>
                                        <form id="acdisform" method="POST" action="AdiscountupdateServlet" class=" form-inline">
                                            ...
                                            <input type="number" style="width:100px;text-align: center; color: black" name="disamount" id="disamount" value="<%= rs.getFloat("DISCOUNT") %>"  required=""><br>
                                            <input type="text" title="Discount Note" name="note" style="width:100px;text-align: center; color: black; margin-top: 2px" value="<%= rs.getString("DIS_NOTE") %>" onchange="acmyFunction()" placeholder="Note" ><br>
                                            <input type="submit" style=" margin-top: 2px; margin-bottom: 2px" class="btn btn-success btn-xs" value="OK">
                                        </form>
