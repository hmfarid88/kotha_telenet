...
<html class="no-js" lang="">
                                                ...
                                                <%
                                                    ...
                                                    try {
                                                        ...
                                                        String query = "select BRAND, MODEL, PRICE, COST_PRICE, count(*) as qty, (PRICE-COST_PRICE) as uprofit, sum(DISCOUNT) as dis"
                                                                + " from mobilesell where SELL_DATE between '" + date1 + "'  and '" + date2 + "'  group by BRAND, MODEL, COST_PRICE, PRICE";
                                                ...
                                                <%                                                    
                                                 try {
                                                        ...
                                                        String query = "select PRODUCT_NAME, SELL_PRICE, COST_PRICE, sum(DISCOUNT) as dss, count(*) as aqty, SELL_PRICE-COST_PRICE as auprofit"
                                                                + " from accessor_sale where DATE between '" + date1 + "'  and '" + date2 + "' group by PRODUCT_NAME, COST_PRICE, SELL_PRICE";
                                                        ps = con.prepareStatement(query);
                                                        rs = ps.executeQuery();
                                                        while (rs.next()) {
                                                ...
                                                <%                                                    
                                                    try {
                                                        ...
                                                        String query = "select sum(SELL_PRICE-COST_PRICE) as aprofit, sum(DISCOUNT) as ttdis, count(PRODUCT_ID) as atqty"
                                                                + " from accessor_sale where DATE between '" + date1 + "'  and '" + date2 + "' ";
                                                        ps = con.prepareStatement(query);
                                                        rs = ps.executeQuery();
                                                        while (rs.next()) {
                                                %>
                                                ...
                                                <tr>
                                                    <th Style="text-align: center">Mobile Phone</th>
                                                        <%                                                            
                                                            try {
                                                                con = Ssymphonyy.getConnection();
                                                                String query = "select sum(PRICE) as saleprice, sum(DISCOUNT) as mtotaldist, sum(COST_PRICE) as cost, count(PRODUCT_ID) as tqty"
                                                                        + " from mobilesell where SELL_DATE between '" + date1 + "'  and '" + date2 + "' ";
                                                                ps = con.prepareStatement(query);
                                                                rs = ps.executeQuery();
                                                                while (rs.next()) {
                                                                    ...
                                                                    request.setAttribute("mdist", rs.getFloat("mtotaldist"));
                                                        %>
                                                    ...
                                                    <td Style="text-align: center"><%= rs.getFloat("saleprice") - rs.getFloat("cost")-rs.getFloat("mtotaldist")%></td>
                                                    <td Style="text-align: center"><%= ((rs.getFloat("saleprice") - rs.getFloat("cost")-rs.getFloat("mtotaldist"))*100)/rs.getFloat("cost") %> %</td>
                                                    <%                  }
                                                        } catch (Exception ex) {
                                                        }finally {
   try { if (rs != null) rs.close(); rs=null; } catch (SQLException ex2) { }
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                                ...
                                                <tr>
                                                    ...
                                                    <td Style="text-align: center">${(msale+asale)-(mcost+acost+acsordis+mdist)}</td>
                                                    <td Style="text-align: center">${(((msale+asale)-(mcost+acost+acsordis+mdist))*100)/(mcost+acost)} %</td>
                                                </tr> 
                                                <tr>
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                                        ...
                                                        <%
                                                            ...
                                                            try {
                                                                ...
                                                                String query = "select sum(AMOUNT) as pcost from profit_cost where  DATE between '" + date1 + "'  and '" + date2 + "'";
                                                                ps = con.prepareStatement(query);
                                                                rs = ps.executeQuery();
                                                                while (rs.next()) {
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                                ...
                                                <tr>
                                                    ...
                                                    <th style=" text-align: center; border-bottom-style: hidden; border-left-style: hidden; border-right-style: hidden"><u>${((msale+asale))-(mcost+acost+acsordis+mdist)-(tcost+pcost)}</u> | (<u>${(((msale+asale)-(mcost+acost+acsordis+mdist))-(tcost+pcost))*100/(mcost+acost)} </u> %)</th>
